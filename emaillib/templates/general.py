...
class LinkEmail(EmailTemplate):

    def GetRequiredArguments(self):
        return ['name', 'uID', 'title', 'description', 'link']
                                  ...
                                  <tr>
                                    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top"
                                      ...
                                      <img class="max-width" border="0"
                                        ...
                                        src="https://static.yyjlincoln.com/yyjlincoln/yyjlincoln-email-header.jpg">
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                                    ...
                                    <td style="padding:0px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                      ...
                                      <div>
                                        <div style="font-family: inherit; text-align: inherit; white-space: pre-line; font-size: 1.17em;">
                                          Hello <div style="font-style: italic; display: inline; font-size: inherit;">{{name}} ({{uID}})</div>,

                                          {{description}}

                                          Please click <a href="{{link}}">here</a> or copy and paste:
                                          ...
                                          <div style="font-style: italic;">DocumentX is a product of yyjlincoln.com. For more information, check out <a href="https://yyjlincoln.com/portfolio/documentx">here</a>.</div>
                                        </div>
                                        <div></div>
                                      </div>
                                    </td>
